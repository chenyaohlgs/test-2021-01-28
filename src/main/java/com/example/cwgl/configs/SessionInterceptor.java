...
//            System.out.println(HandlerMethod.class +"==="+ handler.getClass());
            if(HandlerMethod.class.equals(handler.getClass())){
                Object controller = ((HandlerMethod) handler).getBean();      //反射创建实例对象
                if (controller instanceof UserInfoController){      //instanceof判断左边是否是右边对象实例
